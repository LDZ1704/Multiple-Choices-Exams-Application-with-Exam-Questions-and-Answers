...
if __name__ == '__main__':
    with app.app_context():
        ...
        questions = [
            # Toán học - Đại số
            Question(question_title="2 + 2 = ?", createBy="admin", chapter_id=chapters[0].id, user_id=admin_record.id),
            Question(question_title="Nghiệm của phương trình x² - 4 = 0 là:", createBy="admin",
                     chapter_id=chapters[0].id, user_id=admin_record.id),
            ...
            Question(question_title="Gia tốc trọng trường trên Trái Đất là:", createBy="admin",
                     chapter_id=chapters[3].id, user_id=admin_record.id),
            ...
            Question(question_title="Diện tích hình vuông cạnh 5cm là:", createBy="admin",
                     chapter_id=chapters[1].id, user_id=admin_record.id),
            ...
            Question(question_title="Nhiệt độ sôi của nước ở áp suất tiêu chuẩn:", createBy="admin",
                     chapter_id=chapters[4].id, user_id=admin_record.id),
            ...
            Question(question_title="Điện trở của dây dẫn phụ thuộc vào:", createBy="admin",
                     chapter_id=chapters[5].id, user_id=admin_record.id),
            ...
            Question(question_title="Axit mạnh nhất trong các axit sau:", createBy="admin",
                     chapter_id=chapters[6].id, user_id=admin_record.id),

            # Hóa học - Hóa hữu cơ
            Question(question_title="Công thức phân tử của methane là:", createBy="admin",
                     chapter_id=chapters[7].id, user_id=admin_record.id),
            ...
            Question(question_title="Choose the correct form: 'I ___ to school yesterday'", createBy="admin",
                     chapter_id=chapters[8].id, user_id=admin_record.id),
            ...
            Question(question_title="In the sentence 'The cat is sleeping', what is the subject?", createBy="admin",
                     chapter_id=chapters[10].id, user_id=admin_record.id),
            ...
            Question(question_title="Nước Văn Lang được thành lập vào thời gian nào?", createBy="admin",
                     chapter_id=chapters[11].id, user_id=admin_record.id),
            ...
            Question(question_title="Cuộc khởi nghĩa Tây Sơn diễn ra vào thế kỷ nào?", createBy="admin",
                     chapter_id=chapters[12].id, user_id=admin_record.id),
            ...
            Question(question_title="Cách mạng tháng Tám diễn ra vào năm nào?", createBy="admin",
                     chapter_id=chapters[13].id, user_id=admin_record.id),
            ...
            Question(question_title="Khu vực kinh tế trọng điểm phía Nam là:", createBy="admin",
                     chapter_id=chapters[15].id, user_id=admin_record.id),
            ...
            Question(question_title="Dân số Việt Nam hiện tại khoảng:", createBy="admin",
                     chapter_id=chapters[16].id, user_id=admin_record.id),
            ...
            Question(question_title="Bào quan nào chứa DNA trong tế bào?", createBy="admin",
                     chapter_id=chapters[17].id, user_id=admin_record.id),
        ...
        answers = [
            # Câu hỏi 1: 2 + 2 = ?
            Answer(question_id=questions[0].id, answer_text="3", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[0].id, answer_text="4", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[0].id, answer_text="5", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[0].id, answer_text="6", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 2: Nghiệm của phương trình x² - 4 = 0
            Answer(question_id=questions[1].id, answer_text="x = ±2", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[1].id, answer_text="x = ±4", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[1].id, answer_text="x = 2", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[1].id, answer_text="x = -2", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 3: Công thức tính vận tốc
            Answer(question_id=questions[2].id, answer_text="v = s/t", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[2].id, answer_text="v = s*t", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[2].id, answer_text="v = t/s", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[2].id, answer_text="v = s+t", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 4: Gia tốc trọng trường
            Answer(question_id=questions[3].id, answer_text="9.8 m/s²", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[3].id, answer_text="10 m/s²", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[3].id, answer_text="9.6 m/s²", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[3].id, answer_text="8 m/s²", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 5: Công thức hóa học của nước
            Answer(question_id=questions[4].id, answer_text="H2O", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[4].id, answer_text="H2O2", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[4].id, answer_text="HO", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[4].id, answer_text="H3O", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 6: 3x + 5 = 14
            Answer(question_id=questions[5].id, answer_text="x = 3", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[5].id, answer_text="x = 4", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[5].id, answer_text="x = 5", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[5].id, answer_text="x = 2", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 7: √16 = ?
            Answer(question_id=questions[6].id, answer_text="4", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[6].id, answer_text="8", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[6].id, answer_text="16", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[6].id, answer_text="2", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 8: 2³ = ?
            Answer(question_id=questions[7].id, answer_text="8", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[7].id, answer_text="6", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[7].id, answer_text="9", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[7].id, answer_text="12", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 9: Diện tích hình vuông cạnh 5cm
            Answer(question_id=questions[8].id, answer_text="25 cm²", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[8].id, answer_text="20 cm²", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[8].id, answer_text="10 cm²", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[8].id, answer_text="15 cm²", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 10: Chu vi hình tròn bán kính 7cm
            Answer(question_id=questions[9].id, answer_text="44 cm", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[9].id, answer_text="14 cm", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[9].id, answer_text="22 cm", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[9].id, answer_text="28 cm", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 11: Thể tích hình lập phương cạnh 3cm
            Answer(question_id=questions[10].id, answer_text="27 cm³", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[10].id, answer_text="9 cm³", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[10].id, answer_text="18 cm³", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[10].id, answer_text="36 cm³", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 12: Đạo hàm của x²
            Answer(question_id=questions[11].id, answer_text="2x", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[11].id, answer_text="x²", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[11].id, answer_text="x", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[11].id, answer_text="2x²", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 13: ∫x dx = ?
            Answer(question_id=questions[12].id, answer_text="x²/2 + C", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[12].id, answer_text="x² + C", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[12].id, answer_text="2x + C", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[12].id, answer_text="x + C", is_correct=False, createBy='admin', user_id=admin_record.id),
            ...
            Answer(question_id=questions[13].id, answer_text="Quán tính", is_correct=True, createBy='admin',
                   user_id=admin_record.id),
            Answer(question_id=questions[13].id, answer_text="Gia tốc", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[13].id, answer_text="Tác dụng phản tác dụng", is_correct=False, createBy='admin',
                   user_id=admin_record.id),
            Answer(question_id=questions[13].id, answer_text="Hấp dẫn", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 15: Công thức tính động lượng
            Answer(question_id=questions[14].id, answer_text="p = mv", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[14].id, answer_text="p = ma", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[14].id, answer_text="p = Ft", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[14].id, answer_text="p = mv²", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi 16: Nhiệt độ sôi của nước
            Answer(question_id=questions[15].id, answer_text="100°C", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[15].id, answer_text="0°C", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[15].id, answer_text="50°C", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[15].id, answer_text="200°C", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[16].id, answer_text="Oát (W)", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[16].id, answer_text="Gam (g)", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[16].id, answer_text="Giây (s)", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[16].id, answer_text="Jun (J)", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[17].id, answer_text="V= R/I", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[17].id, answer_text="R = V.I", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[17].id, answer_text="I = R/V", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[17].id, answer_text="V = I.R", is_correct=True, createBy='admin', user_id=admin_record.id),
            ...
            Answer(question_id=questions[19].id, answer_text="0", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[19].id, answer_text="+1", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[19].id, answer_text="-1", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[19].id, answer_text="+2", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[20].id, answer_text="HCl", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[20].id, answer_text="H₂CO₃", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[20].id, answer_text="CH₃COOH", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[20].id, answer_text="H₂S", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[21].id, answer_text="CH₄", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[21].id, answer_text="C₂H₆", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[21].id, answer_text="C₂H₄", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[21].id, answer_text="C₃H₈", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[22].id, answer_text="C₂H₆O", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[22].id, answer_text="C₂H₄O₂", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[22].id, answer_text="C₂H₆", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[22].id, answer_text="CH₃OH", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[23].id, answer_text="go", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[23].id, answer_text="gone", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[23].id, answer_text="went", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[23].id, answer_text="going", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[24].id, answer_text="speak", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[24].id, answer_text="speaks", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[24].id, answer_text="speaking", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[24].id, answer_text="spoken", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[25].id, answer_text="Ugly", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[25].id, answer_text="Pretty", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[25].id, answer_text="Dirty", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[25].id, answer_text="Bad", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[26].id, answer_text="Large", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[26].id, answer_text="Huge", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[26].id, answer_text="Tiny", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[26].id, answer_text="Tall", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[27].id, answer_text="is sleeping", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[27].id, answer_text="The cat", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[27].id, answer_text="sleeping", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[27].id, answer_text="is", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[28].id, answer_text="Past Simple", is_correct=False, createBy='admin', user_id=admin_record.id),
            ...
            Answer(question_id=questions[30].id, answer_text="An Dương Vương", is_correct=True, createBy='admin',
                   user_id=admin_record.id),
            Answer(question_id=questions[30].id, answer_text="Hùng Vương", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[30].id, answer_text="Triệu Đà", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[30].id, answer_text="Ngô Quyền", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[31].id, answer_text="Thế kỷ XVIII", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[31].id, answer_text="Thế kỷ XVII", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[31].id, answer_text="Thế kỷ XIX", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[31].id, answer_text="Thế kỷ XVI", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[32].id, answer_text="Bảo Đại", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[32].id, answer_text="Gia Long", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[32].id, answer_text="Minh Mạng", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[32].id, answer_text="Tự Đức", is_correct=False, createBy='admin', user_id=admin_record.id),

            # Câu hỏi Lịch sử - Cách mạng tháng Tám
            Answer(question_id=questions[33].id, answer_text="1945", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[33].id, answer_text="1946", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[33].id, answer_text="1944", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[33].id, answer_text="1943", is_correct=False, createBy='admin', user_id=admin_record.id),
            ...
            Answer(question_id=questions[35].id, answer_text="Fansipan", is_correct=True, createBy='admin', user_id=admin_record.id),
            ...
            Answer(question_id=questions[35].id, answer_text="Ngoc Linh", is_correct=False, createBy='admin',
                   user_id=admin_record.id),
            Answer(question_id=questions[35].id, answer_text="Bach Ma", is_correct=False, createBy='admin', user_id=admin_record.id),

            Answer(question_id=questions[36].id, answer_text="Sông Hồng", is_correct=False, createBy='admin', user_id=admin_record.id),
            ...
            Answer(question_id=questions[37].id, answer_text="Hà Nội, Hải Phòng, Quảng Ninh và Bắc Ninh",
                   is_correct=False, createBy='admin', user_id=admin_record.id),
            ...
            Answer(question_id=questions[38].id, answer_text="Lúa", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[38].id, answer_text="Ngô", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[38].id, answer_text="Cao su", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[38].id, answer_text="Cà phê", is_correct=False, createBy='admin', user_id=admin_record.id),
            ...
            Answer(question_id=questions[40].id, answer_text="Hà Nội", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[40].id, answer_text="TP. Hồ Chí Minh", is_correct=True, createBy='admin',
                   user_id=admin_record.id),
            Answer(question_id=questions[40].id, answer_text="Cần Thơ", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[40].id, answer_text="Hải Phòng", is_correct=False, createBy='admin', user_id=admin_record.id),
            ...
            Answer(question_id=questions[41].id, answer_text="Nhân tế bào", is_correct=True, createBy='admin',
                   user_id=admin_record.id),
            Answer(question_id=questions[41].id, answer_text="Ti thể", is_correct=False, createBy='admin', user_id=admin_record.id),
            ...
            Answer(question_id=questions[42].id, answer_text="Thụ tinh", is_correct=False, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[42].id, answer_text="Nguyên phân", is_correct=True, createBy='admin', user_id=admin_record.id),
            Answer(question_id=questions[42].id, answer_text="Tiêu hóa", is_correct=False, createBy='admin', user_id=admin_record.id),
